...
,CreateFAQGroupAPIView,ReadFAQGroupAPIView
,UpdateFAQGroupAPIView,DeleteFAQGroupAPIView,CreateFAQAPIView,ReadFAQAPIView,UpdateFAQAPIView
,DeleteFAQAPIView,PictureAllListAPIView,PictureCreateAPIView
,PictureDeleteView,PictureDetailView,PictureUpdateView)
#---------------------------
...
urlpatterns = [
    ...
    path('faq_groups/delete/<int:pk>/', DeleteFAQGroupAPIView.as_view(), name='delete_faq_group'),
